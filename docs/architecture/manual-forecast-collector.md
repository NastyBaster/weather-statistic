...
Scheduling, production deployment, a dashboard trigger, per-location diagnostics, observations, accuracy calculations, and real-data UI are deliberately deferred until the manual development path is reviewed.
