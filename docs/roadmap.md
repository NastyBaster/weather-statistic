...
| **5.3** | **Operational observability for collection health and failures without sensitive logs. The sanitized service-role health RPC is merged and validated in development; production rollout and operational polling remain pending.** | **In progress** |
