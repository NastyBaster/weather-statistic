...
| **6** | **Forecast history backed by real snapshots with an explicit demo/real boundary. Authenticated users now read their RLS-scoped snapshots; observation-based actuals and accuracy remain deferred.** | **In progress** |
