...
Актуальний санітизований стан проєкту зафіксовано в [`docs/project-status.md`](docs/project-status.md),
а консолідовану послідовність наступних етапів — у [`docs/roadmap.md`](docs/roadmap.md).
...
- Санітизовані докази production rollout: [`docs/validation/manual-forecast-collector-production.md`](docs/validation/manual-forecast-collector-production.md).
