...
const VALUE_FLAGS = ["development-name", "production-name", "enqueue-committed", "new-scheduled-runs", "duplicate-identity-count", "counter-invariant", "attempt-boundary", "scheduled-run-baseline"];
